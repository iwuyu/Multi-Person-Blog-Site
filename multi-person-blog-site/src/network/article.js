...
export function getArticlesCount(param) {
  return instance.request({
    method:"get",
    url:`/article/getArticlesCount?categoryId=${param.categoryId}&labelId=${param.labelId}&author=${param.author}&keyword=${param.keyword}`
  })
}
...
export function getArticle(param) {
  return instance.request({
    method:"get",
    url:`/article/getArticle?categoryId=${param.categoryId}&labelId=${param.labelId}&currentPage=${param.currentPage}&pageSize=${param.pageSize}&author=${param.author}&keyword=${param.keyword}`
  })
}
